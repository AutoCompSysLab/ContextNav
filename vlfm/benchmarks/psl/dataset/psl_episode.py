    ...
    def from_json(
        ...
        for i, episode in enumerate(deserialized["episodes"]):
            ...
            if scenes_dir is not None:
                ...
                # Scene path: normalize version suffix
                episode.scene_id = episode.scene_id.replace("hm3d_v0.2", "hm3d")
...
@registry.register_task(name="AttrObjNavTask-v1")
class AttrObjNavTask(NavigationTask):
