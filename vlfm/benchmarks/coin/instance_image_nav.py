...
class InstructionSensor(Sensor):
    ...
    def _get_observation_space(self, *args: Any, **kwargs: Any):
        return spaces.Box(low=0, high=np.inf, shape=(1,), dtype=np.int64)
...
class ImageGoalSensor(Sensor):
    ...
    def get_observation(
        ...
        **kwargs: Any,
        ...
        # otherwise create a temporary sensor to capture the goal image
